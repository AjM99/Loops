...
class BottomBar extends StatelessWidget {
  ...
  Widget get customCreateIcon => Container(
      width: 45.0,
      height: 27.0,
      //this whole child is for making the button at center
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            ...
            children: [
              // 0,1,2,3 are the activation and navigation id
              // eg:if u click Search button u navigate to screen1 which is search screen.
              ...
              customCreateIcon,
              SizedBox(width: 15),
              menuButton('History', FontAwesomeIcons.history, 2),
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              //the conditional statement  is very important,when u switch screens it decides the color
              // of icon and text(black/white) and also decides active/deactive color
              Icon(icon,
                  color: GetIt.instance<FeedViewModel>().actualScreen == 0
